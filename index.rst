.. title:: Databases: MSSQL Bootcamp - None BPG vs. BPG

.. toctree::
   :maxdepth: 2
   :caption: None BPG vs. BPG
   :name: _preparation
   :hidden:
...
Welcome to the DB session on Best Practices; Why are they so much work but deliver such a good result?
